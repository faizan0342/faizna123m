miner forked from IwYeo's SoliditySHA3Miner
...
LICENSE
miner is licensed under the Apache License, Version 2.0 (the "License");
...
Options:
  ...
  pool                    (Pool only) URL of pool mining server (default:   secondaryPool           (Optional) URL of failover pool mining server
...
Note that there is a configuration file "DTSminer.conf" that saves previous CLI parameters/settings, delete it prior to changing CLI parameters.
