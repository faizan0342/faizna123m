...
Current latest public release version: [1.2.0](https://github.com/Mineions/Cminer/releases/latest)
...
### Releases can be found [here](https://github.com/Mineions/miner/releases).


## LICENSE

miner is licensed under the [Apache License, Version 2.0 (the "License")](http://www.apache.org/licenses/LICENSE-2.0);
...
Libraries are included in the Software under the following license terms:
    ...
    Bouncy Castle [https://www.bouncycastle.org/licence.html]
                          ...
                          : LbFkAto1qYt8RdTFHL871H4djendcHyCyB
    

Usage: Cminer [OPTIONS]
...
Options:
    ...
    abiFile                 Token abi in a file (default: 'DTSTC.abi' in the same folder as this miner)
